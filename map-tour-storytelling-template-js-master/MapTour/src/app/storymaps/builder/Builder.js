define(["esri/arcgis/Portal",									/*^A module is different from a traditional script file in that it defines
																*a well-scoped object that avoids polluting the global namespace.
																http://requirejs.org/docs/api.html#define */
		"storymaps/maptour/core/WebApplicationData",
		"storymaps/maptour/builder/FeatureServiceManager",		//^ has dependencies on these files (array of dependency names)
																// The dependencies will be passed to the definition function as function arguments, // listed in the same order as the order in the dependency array
		...
		"esri/request",
		"dojo/topic"],
	function(					//Identifyer - Parameternamen
		esriPortal, 
		WebApplicationData, 
